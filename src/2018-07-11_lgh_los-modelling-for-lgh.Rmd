...
* patients addmitted on __Thursdays__ have a significantly higer LOS by `r round((exp(0.0528716) - 1)*100, 2)`% on average. 
...
It may be worth extending this model both as a tool for inference about the relationships between variables that affect LOS, and for the purpose of predicting LOS at Lions Gate Hospital. 
